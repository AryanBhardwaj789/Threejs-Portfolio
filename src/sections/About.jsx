...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('aryanbhardwaj98126@gmail.com');
        setHasCopied(true);
        setTimeout(() => {
            setHasCopied(false);
        }, 2000)
                    ...
                    <div className='grid-container'>
                        <div className='rounded-3xl w-full sm:h-[326px] h-fit flex justify-center items-center'>
                            <Globe
                                ...
                                labelsData={[
                                    { lat: 43.4675, lng: -79.6877, text: 'I\'m here!', color: 'white', size: 20 }
                                ]}
                            />
                        </div>
                        <div>
                    ...
                    <div className='grid-container'>
                        ...
                        <div className='space-y-2 '>
                            ...
                            <div className='copy-container' onClick={handleCopy}>
                                ...
                                <p className='lg:text-lg md:text-md font-medium text-gray_gradient text-white'> aryanbhardwaj98126@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
